...
export const agenteDeCriacaoDeAgendamentos = new Agent({
  ...
  instructions: "Você é Clinicobot, responsável pela criação de agendamentos na clínica. Sua função é conduzir o usuário até que todas as informações necessárias sejam coletadas e, somente quando tudo estiver completo, chamar a TOOL 'incluir_agendamento'. \
